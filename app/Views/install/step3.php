...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <?php } ?>
      <form action='<?php echo $actualLink.'/install/step4'; ?>' method="post">
        <p>Now you must create the user account that you will use as the "root admin".</p>
        <b>Username</b><br />
        ...
        <b>Email</b><br />
        <div class="input-group mb-3">
          <input type="text" class="form-control" name='email' value="admin@yourro.com">
          <div class="input-group-append">
            <div class="input-group-text">
            </div>
          </div>
