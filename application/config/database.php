...
$db['ragnarok']['password'] = '';
$db['ragnarok']['database'] = '';
$db['ragnarok']['dbdriver'] = 'mysql';
$db['ragnarok']['dbprefix'] = '';
$db['ragnarok']['pconnect'] = TRUE;
$db['ragnarok']['db_debug'] = TRUE;
$db['ragnarok']['cache_on'] = FALSE;
$db['ragnarok']['cachedir'] = '';
$db['ragnarok']['char_set'] = 'utf8';
$db['ragnarok']['dbcollat'] = 'utf8_general_ci';
$db['ragnarok']['swap_pre'] = '';
