				...
				<?php if ($vacation == 0) { ?>
					<li>
						...
						<ul class="nav nav-second-level">
							...
							<li>
								<a href="<?php echo base_url('account/search'); ?>">List/Search Accounts</a>
							</li>
							<?php } ?>
							<?php if ($check_perm['addaccount'] == 1 && $vacation == 0) { ?>
								<li>
									<a href="<?php echo base_url('account/create'); ?>">Create New</a>
								</li>
							<?php } ?>
						</ul>
					</li>
			...
			<?php if ($check_perm['viewchars'] == 1 || $check_perm['whosonline'] == 1) { ?>
				<li>
					...
					<ul class="nav nav-second-level">
						...
						<li>
							<a href="<?php echo base_url('character/search'); ?>">List/Search Characters</a>
						</li>
						<?php } ?>
						<?php if ($check_perm['whosonline'] == 1) { ?>
						<li>
							<a href="<?php echo base_url('character/whosonline'); ?>">View Online</a>
						</li>
						<?php } ?>
					</ul>
				</li>
				...
				<?php if ($vacation == 0) { ?>
					<li>
						...
						<ul class="nav nav-second-level">
							...
							<li>
								<a href="<?php echo base_url('guild/listguilds'); ?>">List/Search Guilds</a>
							</li>
							<?php } ?>
							<?php if ($check_perm['managecastles'] == 1 || $vacation == 0) { ?>
							<li>
								<a href="<?php echo base_url('guild/castles'); ?>">Manage Castles</a>
							</li>
							<?php } ?>
						</ul>
					</li>
					...
					<li>
						...
						<ul class="nav nav-second-level">
							<?php if ($check_perm['atcmdlog'] == 1 && $vacation == 0) { ?>
								<li>
									<a href="<?php echo base_url('gamelogs/atcmd_search'); ?>">@command</a>
								</li>
							<?php } ?>
							<?php if ($check_perm['branchlog'] == 1 && $vacation == 0) { ?>
								<li>
									<a href="<?php echo base_url('gamelogs/branch'); ?>">branch</a>
								</li>
							<?php } ?>
							<?php if ($check_perm['chatlog'] == 1 && $vacation == 0) { ?>
								<li>
									<a href="<?php echo base_url('gamelogs/chat'); ?>">chat</a>
								</li>
							<?php } ?>
							<?php if ($check_perm['loginlog'] == 1 && $vacation == 0) { ?>
								<li>
									<a href="<?php echo base_url('gamelogs/login'); ?>">login</a>
								</li>	
							<?php } ?>
							<?php if ($check_perm['mvplog'] == 1 && $vacation == 0) { ?>
								<li>
									<a href="<?php echo base_url('gamelogs/mvp'); ?>">mvp</a>
								</li>
							<?php } ?>
							<?php if ($check_perm['npclog'] == 1 && $vacation == 0) { ?>
								<li>
									<a href="<?php echo base_url('gamelogs/npc'); ?>">npc</a>
								</li>
							<?php } ?>
							<?php if ($check_perm['picklog'] == 1 && $vacation == 0) { ?>
								<li>
									<a href="<?php echo base_url('gamelogs/pick_search'); ?>">pick</a>
								</li>
							<?php } ?>									
							<?php if ($check_perm['zenylog'] == 1 && $vacation == 0) { ?>								
								<li>
									<a href="<?php echo base_url('gamelogs/zeny_search'); ?>">zeny</a>
								</li>	
							<?php } ?>
						</ul>
					</li>
			...
			<?php if ($check_perm['itemshop'] == 1 || $check_perm['serverconfig'] == 1) { ?>
				<li>
					...
					<ul class="nav nav-second-level">
						<?php if ($ssh_conn == 1) { ?>
						<li>
							<a href="<?php echo base_url('server/hercules'); ?>">Hercules Info/Maintenance</a>
						</li>
						<?php } ?>
						<?php if ($check_perm['itemshop'] == 1 && $vacation == 0) { ?>
							<li>
								<a href="<?php echo base_url('server/itemshop'); ?>">Item Shop</a>
							</li>
						<?php } ?>
						<?php if ($check_perm['serverconfig'] == 1 && $vacation == 0) { ?>
							<li>
								<a href="<?php echo base_url('server/config'); ?>">Server Configuration</a>
							</li>
						<?php } ?>
						<?php if ($check_perm['announcement'] == 1) { ?>
							<li>
								<a href="<?php echo base_url('server/broadcast'); ?>">Server Broadcasts</a>
							</li>
						<?php } ?>
					</ul>
				</li>
					...
					<li>
						...
						<ul class="nav nav-second-level">
							<?php if ($check_perm['viewbugs'] == 1 && $vacation == 0) { ?>
								<li>
									<a href="<?php echo base_url('bugtracker/buglist'); ?>">Bugtracker</a>
								</li>
							<?php } ?>
							<?php if ($check_perm['items'] == 1 && $vacation == 0) { ?>
								<li>
									<a href="<?php echo base_url('server/itemdb'); ?>">Item Database</a>
								</li>
							<?php } ?>
							<?php if ($check_perm['mobs'] == 1 && $vacation == 0) { ?>
								<li>
									<a href="<?php echo base_url('server/mobdb'); ?>">Mob Database</a>
								</li>
							<?php } ?>
							<?php if ($check_perm['sftp'] == 1 && $vacation == 0) { ?>
								<li>
									<a href="<?php echo base_url('server/stfp'); ?>">SFTP Access</a>
								</li>	
							<?php } ?>						
						</ul>
					</li>
					...
					<li>
						...
						<ul class="nav nav-second-level">
							<?php if ($check_perm['itemcount'] == 1 && $vacation == 0) { ?>
								<li>
									<a href="<?php echo base_url('analysis/itemcount'); ?>">Item Count by character</a>
								</li>
							<?php } ?>
							<?php if ($check_perm['level1zeny'] == 1 && $vacation == 0) { ?>
								<li>
									<a href="<?php echo base_url('analysis/level1zeny'); ?>">Level 1 Characters > 1m zeny</a>
								</li>
							<?php } ?>
							<?php if ($check_perm['nocharaccts'] == 1 && $vacation == 0) { ?>
								<li>
									<a href="<?php echo base_url('analysis/nocharaccts'); ?>">Accounts with no characters</a>
								</li>
							<?php } ?>
							<?php if ($check_perm['delcharsaccts'] == 1 && $vacation == 0) { ?>
								<li>
									<a href="<?php echo base_url('analysis/delchars'); ?>">Accounts with deleted characters</a>
								</li>
							<?php } ?>
							<?php if ($check_perm['top100'] == 1 && $vacation == 0) { ?>
								<li>
									<a href="<?php echo base_url('analysis/top100'); ?>">Top100 Characters by parameter</a>
								</li>
							<?php } ?>
							<?php if ($check_perm['mvpkill'] == 1 && $vacation == 0) { ?>
								<li>
									<a href="<?php echo base_url('analysis/mvpkill'); ?>">MVP Kill amount</a>
								</li>
							<?php } ?>
						</ul>
					</li>
			...
			<?php if ($check_perm['editadmin'] == 1 || $check_perm['editgroups'] == 1) { ?>
				<li>
					...
					<ul class="nav nav-second-level">
						...
						<li>
							<a href="<?php echo base_url('admin/groups'); ?>">Group Management</a>
						</li>
						<?php } ?>
						<?php if ($check_perm['editadminnews'] == 1) { ?>
						<li>
							<a href="<?php echo base_url('admin/news'); ?>">News Management</a>
						</li>
						<?php } ?>
						<?php if ($check_perm['viewadminlogs'] == 1) { ?>
						<li>
							<a href="<?php echo base_url('admin/logs'); ?>">Log Management</a>
						</li>	
						<?php } ?>
					</ul>
				</li>
